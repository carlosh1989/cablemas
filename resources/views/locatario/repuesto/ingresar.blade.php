...
<div class="container">
  <form action="{{ url('/admin/locatario') }}" method="POST">{{ csrf_field() }}<br/>
    <div class="row">
      <div class="col l10 offset-l1 s12 m12">
        <div class="card-panel z-depth-4">
          <div class="row">
            <div class="col l12 s12">
              <h5 class="red-text center animated pulse titulo">Ingresando locatario</h5>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="input-field col s12">
              <select name="forma_pago" class="validate">
